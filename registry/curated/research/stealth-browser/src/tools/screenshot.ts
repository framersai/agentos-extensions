...
/**
 * Tool for taking screenshots via stealth browser
 */
export class StealthScreenshotTool implements ITool {
  public readonly id = 'stealth-browser-screenshot-v1';
  /** Tool call name used by the LLM / ToolExecutor. */
  public readonly name = 'stealth_screenshot';
  public readonly displayName = 'Stealth Screenshot';
  public readonly description =
    'Capture a screenshot of the current page or a specific element via the stealth browser. ' +
    'Use for bot-protected sites where regular browser screenshots would show CAPTCHA or block pages.';
  ...
  /**
   * Execute stealth screenshot capture
   */
  async execute(
    input: {
      fullPage?: boolean;
